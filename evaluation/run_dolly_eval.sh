...
MODEL_BASE_DIR="../../out/dolly/merged"

# 4. Define the array of models to evaluate
MODELS=(
    "llama3.2-3b-Instruct-contrastive-less-p0.1-safe-merged"
    "llama3.2-3b-Instruct-gradshield-p0.1-safe-merged"
    "llama3.2-3b-Instruct-standard-less-p0.1-safe-merged"
    "llama3.2-3b-Instruct-cpcaless-p0.1-safe-merged"
)
...
echo "🎉 All Dolly GSM8K evaluations completed successfully!"